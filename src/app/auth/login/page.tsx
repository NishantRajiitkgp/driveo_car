      ...
      <Card className="w-full max-w-md bg-[#0a0a0a] border-white/10">
        ...
        <CardContent>
          ...
          <Button
            ...
            className="w-full bg-white/5 border-white/10 text-white hover:bg-white/10 font-medium"
          >
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0a0a0a] px-3 text-white/30">or sign in with email</span>
            </div>
          </div>
